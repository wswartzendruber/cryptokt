...
fun main() {
    ...
    println("SHA3-512, 1 MB")
    println("- Bouncy Castle: ${time { SHA3Digest(512).transformBuffer(megabyte) }}")
    println("- CryptoKt     : ${time { Sha3DigestAlgorithm(Sha3DigestSize._512).transformBuffer(megabyte) }}")
